...
three <- c(3)
twelve <- c(12)
twohundredfity <- c(250)
three + twelve + twohundredfity
...
```{r}
# Not all vectors are of equal length; adding an additional 'NA' element
